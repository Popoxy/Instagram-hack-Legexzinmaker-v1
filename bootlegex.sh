#!/bin/bash
# code
# recoded by: Legexzinmaker 
# https://github.com/Popoxy
...
echo  | |     ___  __ _  _____  __  \ \  / / | |

echo  | |    / _ \/ _` |/ _ \ \/ /   \ \/ /  | |

echo  |______\___|\__, |\___/_/\_\     \/    |_|

echo                 / |

echo                |___/ 

echo by Legexzinmaker "
...
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m] 30 Followers in 1 hour \e[0m\n"
printf "  \e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m]\e[0m\e[1;93m Ctrl + C to stop \e[0m\n"
printf "\n"
sleep 5
...
printf " \e[1;92mLegex Success\e[0m\n"
fi
sleep 3
done
...
menu() {
printf "\n"
printf " \e[1;31m[\e[0m\e[1;77m01\e[0m\e[1;31m]\e[0m\e[1;93m Boot Followers\e[0m\n"
printf " \e[1;31m[\e[0m\e[1;77m02\e[0m\e[1;31m]\e[0m\e[1;93m Exit\e[0m\n"
printf "\n"
read -p $' \e[1;31m[\e[0m\e[1;77m::\e[0m\e[1;31m]\e[0m\e[1;77m select an option: \e[0m' option
if [[ $option -eq 1 ]]; then
login_user
Boot_followers
